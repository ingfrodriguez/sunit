  ...
  <div  class="container">
    ...
    <div class="card mt-3 card-container" v-if="BanderaSeguridad" >
        ...
        <b-row class="mb-4" align-v="center">
          ...
          <b-col md="11"><h1  class="text-primary ">Crear Cliente</h1></b-col>
        </b-row>
        </header>
            ...
            <div class="form-group">
              ...
              <b-row class="mt-2">
                <b-col md="6">
                  ...
                  <b-form-rating v-model="Cliente.Valoracion" color="#ff8800"></b-form-rating>
                  </b-input-group>
                </b-col>
                <b-col  md="6">
                  <div class="form-group">
      ...
      this.$validator.validate().then(isValid => {
        if (isValid) {
          ...
          .then(response => {
            ...
            setTimeout(()=>{this.$router.push('/Clientes/ListarClientes');}, 2000);
          })
          .catch( error => {
