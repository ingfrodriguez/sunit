        ...
        <b-col cols="9">
          <header>
            <b-row class="mb-4" align-v="center">
              ...
              ></b-col>
              <b-col md="10"
                ><h1 class="text-primary">Listado Salidas</h1></b-col
              >
            </b-row>
          </header>
        </b-col>
        <b-col cols="3">
          <b-button href="Salida" variant="light"
            >Salida de Producto de Inventario<b-icon font-scale="1" icon="bag-plus"></b-icon
          ></b-button>
        </b-col>
      </b-row>
      <b-row>
      ...
      <b-row class="mb-3">
        <b-col cols="5">
          <b-input-group prepend="Correlativo" >
           <b-form-input v-model="Correlativo" placeholder="Correlativo de la salida"></b-form-input>
          </b-input-group>
        </b-col>
        <b-col cols="2">
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'FechaSalida', sortable: true,label: 'Fecha Salida' },
        { key: 'TipoSalida.Nombre', sortable: true, label: 'Tipo Salida' },
        { key: 'Ver', label: 'Ver' }
      ],
      items: [],
      filter:null,
  ...
  mounted() {
    axios
      .get(this.$IPServidor + '/api/ListarSalidas', {
        headers: authHeader(),
      })
      .then((response) => {
  ...
  methods: {
    Filtrar(){
      axios({
            method:'GET',
            headers: authHeader(),
            url:this.$IPServidor + '/api/ListarSalidas',
            params:{
              Del:this.Del,
              Al:this.Al,
